...
//    public List<HashMap<String,String>> datamap = DataHelper.data();
    ...
    public ShoppingCart(){
    	...
    	sampleData.put("username","marceloddiazr@gmail.com");
    	sampleData.put("password","Marce13");
    ...
    public void i_open_automationpractice_website() throws Throwable {
    	...
    	driver.get("https://ticketweb.com.tweb.twdev2.websys.tmcs/twlogin"); //http://automationpractice.com");
    }
